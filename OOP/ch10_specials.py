def get_specials():
    ...
    wednesday = {'B': 'Horseradish omlet. Note: better than it sounds',
              'L': 'Momma\'s Curry. Note: Can be made spicy.',
              'D': 'Beef brisket. Note: Comes with au jus. That\'s pronouced "Oh jhoo", not "Ow Juice"'}
    thursday = {'B': 'Horseradish omlet. Note: better than it sounds',
              'L': 'Momma\'s Curry. Note: Can be made spicy.',
              'D': 'Beef brisket. Note: Comes with au jus. That\'s pronouced "Oh jhoo", not "Ow Juice"'}
    friday = {'B': 'Horseradish omlet. Note: better than it sounds',
              'L': 'Momma\'s Curry. Note: Can be made spicy.',
              'D': 'Beef brisket. Note: Comes with au jus. That\'s pronouced "Oh jhoo", not "Ow Juice"'}
    saturday = {'B': 'Horseradish omlet. Note: better than it sounds',
              'L': 'Momma\'s Curry. Note: Can be made spicy.',
              'D': 'Beef brisket. Note: Comes with au jus. That\'s pronouced "Oh jhoo", not "Ow Juice"'}
    sunday = {'B': 'Horseradish omlet. Note: better than it sounds',
              'L': 'Momma\'s Curry. Note: Can be made spicy.',
              'D': 'Beef brisket. Note: Comes with au jus. That\'s pronouced "Oh jhoo", not "Ow Juice"'}
